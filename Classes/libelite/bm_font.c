 ...
 *  Copyright 2010 Jaroslaw Szpilewski. All rights reserved.
 *
 */
...
//loads a BMFont (or hiero) fnt file
//it doesn't load the opengl texture! you'll have to load it (the texture fn is stored in the tex_filename field
...
// this method works 100% with hiero fonts but doesn't load BMFont ones
// don't use this :]
...
//approximate width of a string in pixels (doesn't count in scaling, etc!)
...
//well - we don't allocate anything ... so there's not much to do.
