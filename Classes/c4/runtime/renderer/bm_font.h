 ...
 *	
 *	Methods for loading .fnt bitmapfont files created with BMFont and hiero(?)
 *
 *  Hiero fnts seem to work - but it's not tested and the hiero renderer sucks on OS X ... so get a VM and run BMFont!
